  ...
  return (
    ...
    >
      <div className="relative">
        <div 
          className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 mx-auto mb-2 sm:mb-3 flex items-center justify-center text-muted-foreground transition-all duration-300 group-hover:scale-110 relative z-10"
      ...
      <div className="text-center">
        <h4 className="text-xs sm:text-sm font-dev font-medium text-foreground group-hover:text-foreground transition-colors duration-300 mb-1 sm:mb-2 flex items-center justify-center min-h-[1.5rem] z-10 relative">
          {skill.name}
        </h4>
