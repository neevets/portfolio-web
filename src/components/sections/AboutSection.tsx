                ...
                <div className="relative border border-border/80 bg-card/85 backdrop-blur-sm p-10 lg:p-12 rounded-md">
                  <div className="relative z-10 space-y-6 text-center">
                    ...
                    <p className="text-lg md:text-xl leading-relaxed text-muted-foreground max-w-3xl mx-auto font-dev">
                      I am a young fullstack developer with a focus on systems programming. I pick up new things fast and tend to go further than what&apos;s strictly required, mostly out of curiosity. Comfortable working across the stack but most at home in Go and Rust.
                    </p>
                  </div>
                </div>
